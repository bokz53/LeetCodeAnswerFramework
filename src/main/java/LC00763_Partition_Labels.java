...
public class LC00763_Partition_Labels extends BaseMain {
    ...
    public static void main(String[] args) {
        ...
        LC00763_Partition_Labels lc = new LC00763_Partition_Labels();

        tryYourAnswer(lc::partitionLabels, inputStrList);
    }
